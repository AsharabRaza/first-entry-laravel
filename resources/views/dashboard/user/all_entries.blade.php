                                                            ...
                                                            <li class="list-group-item justify-content-between">
                                                                ...
                                                                @if((strtotime($current_datetime) > strtotime($end_datetime)) OR (strtotime($current_datetime) >= strtotime($start_datetime) && strtotime($current_datetime) <= strtotime($end_datetime)))
                                                                    @if(strtotime($current_datetime) > strtotime($end_datetime))
                                                                        <a href="{{ route('user.all-winners',['id'=>$lottery->id]) }}" class="badgetext badge bg-danger rounded-pill" data-bs-placement="top" data-bs-toggle="tooltip-danger" title="Total losers">{{ $lottery->selected_total_losers }}</a>

                                                                        <a href="{{ route('user.all-losers',['id'=>$lottery->id]) }}" class="badgetext badge bg-info rounded-pill" style="margin-right: 3px;" data-bs-placement="top" data-bs-toggle="tooltip-info" title="Total winners">{{ $lottery->selected_total_winners }}</a>
                                                                    @endif
