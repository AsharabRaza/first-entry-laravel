                        ...
                        <div class="card">
                            ...
                            <form id="change_password_form" method="POST" style="display: inline-grid;">
                                ...
                                <div class="card-footer text-end">
                                    <button class="btn btn-primary" type="submit" id="update_btn" style="float: right;position: relative;" {{ ($data['user']->in_review == 1 || ($data['user']->in_review != NULL && $data['user']->review_approves == 0)) ? 'disabled' : '' }}>
                                        <span style="-webkit-transition: all 0.2s;transition: all 0.2s;">{{ $data['user']->in_review == NULL ? 'Submit' : 'Update'}}</span>
        ...
        $('#change_password_form').submit(function(e){
            ...
            if($('#old_pwd').val() != '' && $('#new_pwd').val() != '' && $('#retype_pwd').val() != ''){
                if(new_pwd == retype_pwd){
                    ...
                    data.append("check_change_pwd", "true");
