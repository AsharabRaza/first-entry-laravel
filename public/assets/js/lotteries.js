          ...
          if (res.success == true) {
            ...
            var qrcode = new QRCode(document.getElementById("genqrcode"), {
                ...
                onRenderingEnd(qrCodeOptions, dataURL){
                    ...
                    $.ajax({
                        url: URL_+'core/lotteries.php?s_qrcode=true',
                        type: 'POST',
                        dataType: 'json',
                    ...
                    data2.append("qrcode", dataURL);
                    data2.append("parent_id", parent_id);
        
                    data2.append("s_qrcode", "true");
                    data2.append("POST", "true");
